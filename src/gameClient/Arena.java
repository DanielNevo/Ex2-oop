...
public class Arena {
	...
	private static Point3D MIN = new gameClient.util.Point3D(0, 100,0);
	private static Point3D MAX = new gameClient.util.Point3D(0, 100,0);
	...
	private void init( ) {
		...
		MIN = new Point3D(x0-dx/10*100,y0-dy/10);
		MAX = new gameClient.util.Point3D(x1+dx/10,y1+dy/10);
